...
function SettingsPage({ settings, onSetting, onReload }) {
  ...
  const resetLearningHistory=async()=>{if(!window.confirm('학습 기록과 오늘 세션 완료 상태를 초기화할까요? 이 작업은 되돌릴 수 없어요.'))return;await Promise.all([storage.clear('sessions'),storage.clear('curriculum')]);onReload();};
